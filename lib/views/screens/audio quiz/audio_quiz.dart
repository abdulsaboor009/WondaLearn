...
class AudioQuizScreen extends StatefulWidget {
  const AudioQuizScreen({super.key});
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          30.height,
                          NiceButtons(
                            startColor: AppColors.yellowColor,
                            endColor: AppColors.yellowColor,
                            borderColor: const Color(0xffEDB900),
                            borderRadius: 34,
                            stretch: false,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SemiBoldTextWidget(
                    color: AppColors.primaryColor,
                    fontSize: AppFontSize.discription + ResponsiveSize.setSp(1),
                    text: 'Answer: ${question[0]}',
                  ),
                  16.height,
                  SecondaryButton(
                    centerContent: 'Next',
